...
path = os.getcwd()
module = "memory" # TODO: Cambiar según haga falta
...
if __name__ == "__main__":
    ...
    if test == "batallaPorNordelta":
        ...
        replace_module_config("memoria{}".format(camelCaseTest))  
        print("Deben ejecutarse los 3 modulos")
        ...
        replace_module_config("reemplazoMMUClock") 
        print("Deben ejecutarse los 3 modulos")
        print('Debe ejecutarse el carpincho "PruebaMMU" conectado a kernel.')

    elif test == "mmuLRU":
        replace_module_config("reemplazoMMULRU")  
        print("Deben ejecutarse los 3 modulos")
        print('Debe ejecutarse el carpincho "PruebaAsignacion" conectado a kernel.')
        ...
        replace_module_config("memoriaTLBFIFO")
        print("Deben ejecutarse los 3 modulos")
        print('Debe ejecutarse el carpincho "prueba_tlb_fifo" conectado a kernel.')

    elif test == "tlbLRU":
        replace_module_config("memoriaTLBLRU")
        print("Deben ejecutarse los 3 modulos")
